...
<main class="container">
  <div class="button-row">
    ...
    <input type="date" bind:value={startDate} on:change={(e) => { filterTransactions_(); (e.target as HTMLInputElement).blur(); }} />
    <input type="date" bind:value={endDate} on:change={(e) => { filterTransactions_(); (e.target as HTMLInputElement).blur(); }} />
